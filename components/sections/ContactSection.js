  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#0a0f1f] via-[#111827] to-[#050816] text-white px-6 py-20 flex items-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
        ...
        {/* Right Side - Form */}
        <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-md shadow-2xl shadow-cyan-500/10">
          ...
          {status && (
            <div className="mt-5 bg-green-500/10 border border-green-400/20 text-green-300 rounded-xl p-4 text-center font-medium">
              {status}
            </div>
          )}
        </div>
